...
export type GetPracticesByClubQuery = { __typename?: 'Query', practiceSummariesByClub: Array<{ __typename?: 'PracticeSummary', id: string, scheduledAt: any, status: PracticeStatus, setsCount: number, attendingCount: number, notAttendingCount: number, unconfirmedCount: number, plannedBy: { __typename?: 'User', id: string, firstName: string, lastName: string, username: string } }> };
...
export type PracticeSetRatingChangedSubscription = { __typename?: 'Subscription', practiceSetRatingChanged: { __typename?: 'PracticeSetRatingEvent', setId: string, practiceId: string, rating?: string | null, eventType: EventType } };
